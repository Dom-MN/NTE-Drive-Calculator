...
class MonsterCatalogPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.search_edit.setPlaceholderText(tr("搜索正式 ID、模板、类路径、profile/pack"))
        self.search_edit.textChanged.connect(self._schedule_refresh)
        filters.addWidget(self.search_edit, 0, 0, 1, 3)

        self.domain_combo = QComboBox()
        self.domain_combo.addItem(tr("全部数据域"), "all")
        self.domain_combo.addItem(tr("怪物"), "monster")
        self.domain_combo.addItem(tr("玩法"), "encounter")
        ...
        self.region_edit.setPlaceholderText(tr("地区 / 副本类目"))
        ...
        self.load_more_button = QPushButton(tr("加载更多"))
